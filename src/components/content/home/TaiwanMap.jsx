...
export default function TaiwanMap(props) {
  const { onClick, onMouseOver, onMouseLeave, active } = props

  useEffect(() => {
    let element = document.querySelector(`[data-name="${active}"]`)
    !!element && element?.classList.add("title_area_now");

    return () => {
      element?.classList.remove("title_area_now");
    }
  }, [active])
  ...
  return (
    ...
    >
      ...
      <title>台灣地圖</title>
      <path
        onMouseEnter={(e) => onMouseOver(e.target.getAttribute('data-name'))}
        onMouseLeave={(e) => onMouseLeave()}
        onClick={(e) => onClick(e.target.getAttribute('data-name'))}
